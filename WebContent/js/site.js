function validaFaleConosco() {
	...
	if ( document.frmfaleconosco.opcaoProduto.value == "" ){
		alert("Selecione o produto que deseja receber as informações.")
	...
	return true;
}// FIM DAS VALIDAÇÕES DE PREENCHIMENTO DOS CAMPOS DO FORMULARIO
...
function verificaMotivo(motivo) {
	...
	if (motivo == "PR") {
		...
		// Criamos um elemento (tag) <option> e guardamos na variável homônia
		var option = document.createElement("option");
		// Setamos nesse novo option o atributo 'value' como valor "FR"
		...
		// Colocamos o option criado como "filho" na tag select criada
		select.appendChild(option);
		// Conteúdo atual da variável select:

		// <select name="selproduto">
		// <option value="">Escolha</option><option
		// value="FR">Freezer</option><option value="GE">Geladeira</option>
		// </select>

		// Colocamos o select criado como "filho" da tag div capturada no inicio
		// da função
		elemento.appendChild(select);
		// Se o valor da variável motivo nao for "PR"...
	} else {
